...
public class PetStoreService {
  ...
  private Customer findOrCreateCustomer(Long petStoreId, Long customerId) {
    ...
    return new findCustomerById(customerId, petStoreId);
  }
  ...
  public Employee findEmployeeById(Long petStoreId, Long employeeId) {
    Employee employee = employeeDao.findById(employeeId).orElseThrow( () -> new 
        NoSuchElementException(employeeId + " was not found."));
  ...
  public Customer findCustomerById(Long petStoreId, Long customerId) {
    Customer customer = customerDao.findById(customerId).orElseThrow( () -> new 
        NoSuchElementException(customerId + " was not found."));
    boolean found = false;
    ...
    if(!found) {
      throw new IllegalArgumentException("The Customer with ID=" + customerId 
          + " is not a member of the pet store.");
    }
    return customer;
  }
